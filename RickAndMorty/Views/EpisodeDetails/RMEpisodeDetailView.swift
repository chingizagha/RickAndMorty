...
extension RMEpisodeDetailView {
    ...
    private func createCharacterLayout() -> NSCollectionLayoutSection {
        ...
        let group = NSCollectionLayoutGroup.horizontal(layoutSize: .init(widthDimension: .fractionalWidth(1.0), heightDimension: .absolute(UIDevice.isiPhone ? 260 : 320)), subitems: UIDevice.isiPhone ? [item, item] : [item, item, item, item]
        )
